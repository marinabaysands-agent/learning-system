...
// Tag definitions
const TAGS = {
  'ai-product': { label: 'AI 产品', color: 'oklch(58% 0.08 280)' },
  'leadership': { label: '领导力', color: 'oklch(58% 0.08 30)' },
  'product-management': { label: '产品管理', color: 'oklch(58% 0.08 150)' },
  'engineering': { label: '工程', color: 'oklch(58% 0.07 200)' },
  'future-of-work': { label: '未来工作', color: 'oklch(58% 0.08 310)' },
  'speed': { label: '速度', color: 'oklch(58% 0.07 60)' },
  'focus': { label: '聚焦', color: 'oklch(58% 0.07 90)' },
  'org-design': { label: '组织设计', color: 'oklch(58% 0.07 120)' },
  'strategy': { label: '战略', color: 'oklch(58% 0.07 0)' },
  'decision-making': { label: '决策', color: 'oklch(58% 0.07 45)' },
  'self-reflection': { label: '自我反思', color: 'oklch(58% 0.06 180)' },
  'venture-capital': { label: '风投', color: 'oklch(58% 0.07 240)' },
  'growth': { label: '增长', color: 'oklch(58% 0.08 140)' },
  'consumer-product': { label: '消费产品', color: 'oklch(58% 0.07 170)' },
  'viral-loops': { label: '病毒传播', color: 'oklch(58% 0.08 350)' },
  'startup': { label: '创业', color: 'oklch(58% 0.08 20)' },
  'hiring': { label: '招聘', color: 'oklch(58% 0.06 260)' },
  'culture': { label: '文化', color: 'oklch(58% 0.06 290)' },
